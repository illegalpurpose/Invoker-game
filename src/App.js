...
function App() {
	...
	const setCircles = (key) => {
		if (
			(key === keyQuas || key === keyWex || key === keyExort) &&
			gameState === "Started"
		) {
	...
	const handleKeyClick = (event) => {
		...
		mode === "new"
			...
			: invokeOldInvokerSpells(event.keyCode);
	};
						...
						<div className="firstBlock">
							...
							<div className="controlls">
								...
								<ul className="controll__list">
									...
									<li>
										<img
											src={mode === "new" ? invokeImg : old_invoke}
											alt="invoke"
										></img>
								...
								{mode === "new" ? (
									<ul className="spell__list">
										<li>
											...
											<p>
												Cold Snap - {String.fromCharCode(keyQuas)}{" "}
										...
										<li>
											...
											<p>
												Ghost Walk - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
										...
										<li>
											...
											<p>
												Ice Wall - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
										...
										<li>
											...
											<p>
												EMP - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										<li>
											...
											<p>
												Tornado - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										<li>
											...
											<p>
												Alacrity - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										<li>
											...
											<p>
												Sun Strike - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										<li>
											...
											<p>
												Forge Spirit - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										<li>
											...
											<p>
												Chaos Meteor - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										<li>
											...
											<p>
												Deafening Blast - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
									...
									<ul
										className="spell__list"
										style={{ overflowX: "hidden", overflowY: "scroll" }}
									>
										<li>
											<img src={icy_path} alt="icy_path"></img>
											<p>
												Icy Path - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Portal - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Betrayal - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Mana Burn - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Tornado Blast - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Telelightning - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Shock - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Frost Nova - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Power Word - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Shroud of Flames - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Disarm - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											<img
												src={old_deafening_blast}
												alt="old_deafening_blast"
											></img>
											<p>
												Deafening Blast - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Firebolt - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Arcane Arts - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Energy Ball - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Firestorm - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Lightning Shield - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Incinerate - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Inferno - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Levitation - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
										...
										<li>
											<img
												src={invisibility_aura}
												alt="invisibility_aura"
											></img>
											<p>
												Invisibility Aura - {String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Soul Reaver - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Confuse - {String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyWex)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Scout - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyExort)}{" "}
												{String.fromCharCode(keyQuas)}
											</p>
										</li>
										...
										<li>
											...
											<p>
												Soul Blast - {String.fromCharCode(keyWex)}{" "}
												{String.fromCharCode(keyQuas)}{" "}
												{String.fromCharCode(keyExort)}
											</p>
										</li>
